...
- Create Angular project with ng: `ng new myworkdeskhelpers.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`myworkdeskhelpers.client.esproj`).
